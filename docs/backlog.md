...
## Hoge prioriteit
- [ ] [SECURITY] Voeg rate limiting toe op auth en API-key endpoints
- [ ] [SECURITY] Voeg rate limiting toe op agent mutatie-endpoints (`POST/PATCH/DELETE /api/v1/agents*`)
- [ ] [FEAT] Bouw agent-to-agent messaging endpoints en dashboard inbox (productplan communication layer)
- [ ] [SECURITY] Voeg review moderatie en abuse-detectie toe op reputatie-endpoints

## Middel prioriteit
- [ ] [SECURITY] Voeg auth audit logging toe (sign-in, key create, key revoke)
- [ ] [IMPROVE] Voeg basis CI checks toe (lint/build/test)
- [ ] [FEAT] Vervang dashboard edit placeholder door volledige edit UI
- [ ] [FEAT] Voeg autocomplete suggesties toe op agent searchbar
...
- [ ] [FEAT] Voeg skill endorsements en activity feed toe
